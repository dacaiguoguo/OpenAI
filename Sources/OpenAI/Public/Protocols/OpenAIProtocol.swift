...
public protocol OpenAIProtocol {
    ...
    **/
    func completionsStream(query: CompletionsQuery, header:[String: String], onResult: @escaping (Result<CompletionsResult, Error>) -> Void, completion: ((Error?) -> Void)?)
    ...
    **/
    func chats(query: ChatQuery, header:[String: String], completion: @escaping (Result<ChatResult, Error>) -> Void)
    ...
    /**
     ...
     - Parameters:
       ...
       - completion: A closure that is being called when all chunks are delivered or uncrecoverable error occured
    **/
    func chatsStream(query: ChatQuery, header:[String: String], onResult: @escaping (Result<ChatStreamResult, Error>) -> Void, completion: ((Error?) -> Void)?)
